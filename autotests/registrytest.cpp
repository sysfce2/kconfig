...
private Q_SLOTS:
    void initTestCase()
    {
        ...
        QVERIFY(QProcess::execute(QStringLiteral("reg"), {QStringLiteral("import"), QStringLiteral("C:/Users/tobias/Documents/registry_test_hkcu.reg")}) == 0);
        if (QProcess::execute(QStringLiteral("reg"), {QStringLiteral("import"), QStringLiteral("C:/Users/tobias/Documents/registry_test_hklm.reg")})) {
